...
<html lang="es" dir="ltr">
  ...
  <body>
    ...
    <div class="column">
      <h1 class="subtitle is-2 has-text-centered">Editar Curso</h1>
    <form method="post" action="{{ route('subject.update', $subject->id) }}">
        ...
        <div class="field">
          <div class="control">
        <input type="text" name="codigo" value="{{$subject->codigo}}" class="input is-primary is-large has-text-centered is-rounded" required placeholder="Codigo"><br>
          </div>
        </div>

        <div class="field">
          <div class="control">
        <input type="text" name="name" value="{{$subject->name}}" class="input is-primary is-large has-text-centered is-rounded" required placeholder="Name"><br>
          </div>
        </div>
